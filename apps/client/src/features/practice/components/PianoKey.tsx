  ...
  return (
    <motion.button
      ...
      className={[
        ...
        isBlack
          ? "absolute top-2 z-20 h-[61%] rounded-b-[0.8rem] border-x-black border-b-black border-t-zinc-700 bg-[linear-gradient(90deg,#050505_0%,#171717_16%,#050505_48%,#252525_68%,#030303_100%)] px-1 pt-9 text-xs text-zinc-100 shadow-[0_18px_24px_rgba(0,0,0,0.7),inset_4px_0_8px_rgba(255,255,255,0.04),inset_-6px_0_10px_rgba(0,0,0,0.62)] sm:pt-10 md:pt-11 lg:pt-12"
          : "relative h-full flex-1 rounded-b-[1.05rem] border-x-zinc-300 border-b-zinc-400 border-t-zinc-100 bg-[linear-gradient(90deg,#d9d9dc_0%,#ffffff_8%,#f9fafb_52%,#e4e4e7_100%)] px-1 pb-4 pt-[9.2rem] text-sm text-zinc-900 shadow-[inset_5px_0_10px_rgba(255,255,255,0.9),inset_-7px_0_12px_rgba(0,0,0,0.08),inset_0_-18px_20px_rgba(0,0,0,0.10),0_10px_18px_rgba(0,0,0,0.18)] sm:pt-[10rem] md:pt-[11.25rem] lg:pt-[12.8rem]",
    ...
    >
      <span
        ...
        className={[
          ...
          isBlack ? "h-10 bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.08),transparent)]" : "h-16 bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.85),transparent)]"
        ].join(" ")}
      />
      {keyboardKey && (
        <span
      ...
      <span className={isBlack ? "relative z-10 text-2xl font-black leading-none text-zinc-100 md:text-3xl" : "relative z-10 text-3xl font-black leading-none tracking-tight md:text-4xl"}>{noteId}</span>
    </motion.button>
  );
};