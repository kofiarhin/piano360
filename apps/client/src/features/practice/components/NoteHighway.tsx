...
export const NoteHighway = ({
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-zinc-950/70 px-4 py-4 shadow-[0_24px_80px_-56px_rgba(0,0,0,0.95)] md:px-6 md:py-5">
      ...
      {isComplete ? (
        ...
        <>
          <div className="relative mx-auto h-44 max-w-6xl overflow-hidden rounded-[1.25rem] border border-white/[0.07] bg-[#09090d] md:h-48">
            <div className="absolute inset-y-0 left-1/2 w-px bg-violet-200/70 shadow-[0_0_28px_rgba(139,92,246,0.58)]" />
            <div className="absolute left-1/2 top-3 -translate-x-1/2 rounded-full border border-violet-300/30 bg-violet-300/10 px-3 py-1 text-[0.65rem] font-black uppercase text-violet-100">
              Playhead
            </div>
            ...
            <motion.div
              className="absolute top-10 flex items-center gap-6"
              style={{ left: "50%" }}
