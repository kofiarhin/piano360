...
export const NoteHighway = ({
  ...
  return (
    <section className="practice-note-highway relative overflow-hidden rounded-[1.25rem] border border-white/10 bg-zinc-950/70 px-3 py-3 shadow-[0_20px_70px_-56px_rgba(0,0,0,0.95)] md:px-4 md:py-3">
      ...
      {isComplete ? (
        ...
        <>
          <div className="practice-note-highway-track relative mx-auto h-36 max-w-6xl overflow-hidden rounded-[1rem] border border-white/[0.07] bg-[#09090d] md:h-40">
            ...
            <motion.div
              className="practice-note-lane absolute top-8 flex items-center gap-6"
              style={{ left: "50%" }}
